...
import org.cgsdream.recyclerview.adapters.MutiItemAdapter;
 ...
 */
public class MutiItemRecyclerViewFragment extends Fragment implements View.OnClickListener {
	private RecyclerView mRecyclerView;
	private ImageButton mAddButton;
	private MutiItemAdapter mAdapter;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		mAdapter = new MutiItemAdapter(dataList);
